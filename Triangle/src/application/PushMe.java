...
import javafx.stage.Stage;
	...
	{ 
		...
		{ 
			...
			//used getText().toUpperCase method to change text to uppercase
			
			Button lengthButton = new Button();
			lengthButton.setText("Letter Count");
			lengthButton.setOnAction(e -> pushMeLabel.setText("Number of Letters: " + pushMeTextField.getText().length()));
			...
			root.getChildren().addAll(pushMeTextField, pushMeButton, lengthButton, pushMeLabel); 
